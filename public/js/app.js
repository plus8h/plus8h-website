 ...
 */
// require('./bootstrap');
__webpack_require__(/*! ./components/nav.js */ "./resources/js/components/nav.js");
...
var navbarDropdownContainerId = document.getElementById('navbarDropdownContainer');
...
if (navbarBtnId) {
  navbarBtnId.addEventListener('click', function (e) {
    var navbarDropdownContainerClassList = navbarDropdownContainerId.classList;
